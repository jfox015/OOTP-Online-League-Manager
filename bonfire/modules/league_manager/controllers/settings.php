...
class Settings extends Admin_Controller {
    ...
    private function save_settings()
    {
		...
		$data = array(
            array('name' => 'osp.game_sport', 'value' => $this->input->post('game_sport')),
            array('name' => 'osp.game_source', 'value' => $this->input->post('game_source')),
            array('name' => 'osp.source_version', 'value' => $this->input->post('source_version')),
            array('name' => 'osp.league_id', 'value' => $this->input->post('league_id')),
            array('name' => 'osp.use_game_details', 'value' => ($this->input->post('use_game_details')) ? 1 : -1),
            ...
            array('name' => 'osp.league_file_path', 'value' => $this->input->post('league_file_path')),
