...
<div class="admin-box">
	...
	<table class="table table-striped">
        ...
        if (isset($team_owners) && is_array($team_owners) && count($team_owners)) :
			...
			<tr>
				<td><img src="<?php echo $settings['osp.team_logo_url'].str_replace(".","_50.",$team->logo_file); ?>" width="50" height="50" border="0" alt="<?php echo $team_name; ?>" title="<?php echo $team_name; ?>" /></td>
